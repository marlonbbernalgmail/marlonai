...
### Jan 2021 - Present | Independent Software Engineer / Contract Developer

**Self-employed | Project-based contracts and product development | Morong, Rizal, Philippines**

- Delivered project-based software development, maintenance, and automation work for business operations and client needs.
- Built and maintained POS, inventory, and mobile ordering systems across web and mobile environments.
- Designed and maintained serverless Firebase backends, including deployments, maintenance, and performance improvements.
- Delivered end-to-end features from requirements gathering through implementation and release for operational workflows.

Selected products and engagements:

- **Smart Laundry POS PH / Laundry POS and Operations (2026-Present):** Published Android app and POS platform for laundry shops covering order/job tracking, receipts, machine tags, sales reporting, staff activity, consumables audit, payments, pricing, and operational reporting.
- **Smart POS PH:** AI-assisted point-of-sale system for sales insights, low-stock alerts, best-seller analysis, profit snapshots, smart restock recommendations, and peak-hour detection.
- **Grocery POS and Inventory (2025-2026):** Laravel, Vue, MySQL, and React Native stack for stock management, sales, and reporting.
- **Grocery Delivery App (2025):** React Native and Firebase application for browsing, cart flows, and delivery orders.
- **TurboDial Dialer / Call Center CRM:** Laravel, Angular, Doctrine, Redis, MySQL, WebSocket, HubSpot, and Twilio platform for sales teams, call center CRM workflows, and dialer operations.

### Jan 2017 - Jan 2021 | Senior Software Engineer

**Zigzag Offshoring | Remote**

- Developed enterprise insurance web applications supporting complex workflows and high-volume transaction processing.
- Implemented backend processing and UI features to improve accuracy in data handling and approvals.
- Improved system reliability and performance through optimization and issue resolution with cross-functional teams.

Key projects:

- **Health Insurance Claims Verification System:** Automated verification workflows using aggregated government database data with Laravel, Vue, React, Node.js, GraphQL, MySQL, and Python.
- **Viisor / Modwatch Workers Compensation Claims Management Platform:** Contributed as a senior software engineer/full-stack developer to production claims, reporting, workflow, and analytics features during the Zigzag engagement.

### Jan 2015 - Jan 2017 | Senior Software Engineer

**Magellan Solutions | Philippines**

- Led development of call center analytics dashboards and internal automation tools.
- Built reporting features for agent performance and operational metrics.
- Supported deployments, scaling, and production reliability improvements.

Key project:

- **Call Center Analytics Platform:** Real-time dashboard for performance and operational reporting built with PHP, MySQL, Laravel, and Vue.js.

### Jul 2014 - Jan 2015 | Software Developer / Project Manager

**Highlysucceed Ltd | Remote**

- Delivered multiple client web applications through rapid iteration and direct stakeholder collaboration.
- Handled end-to-end development across frontend and backend with a focus on maintainability and fast delivery.

Key project:

- **Client web applications:** Portfolio sites, mini checkout systems, and internal business automation tools.

### Feb 2013 - Jul 2014 | Web Developer

**Mindblow Creatives | Philippines**

- Converted PSD designs into responsive, standards-compliant web pages.
- Customized WordPress themes and plugins to match client branding and functional requirements.

Key project:

- **Client marketing sites and WordPress builds:** PSD-to-HTML delivery, theme customization, and plugin enhancements.
...
PHP, Laravel, Node.js, Python, Perl, REST APIs, GraphQL, secure API design, debugging, performance tuning

### Data & Storage

MySQL, Firebase Auth, Firestore, Firebase Storage, Redis, reporting data, operational metrics, data accuracy, production issue resolution

### Frontend

React.js, Next.js, Vue.js, JavaScript, TypeScript, HTML5, CSS3, Tailwind CSS, Bootstrap, responsive UI, accessible UI, Vite, Webpack

### Mobile

React Native, Android-focused delivery, offline-first patterns, app performance, mobile release workflow

### CMS

WordPress theme customization and plugin enhancements

### Tools & Delivery

Git, GitHub, CI/CD, AWS, shared hosting, Firebase tooling, monitoring, logging, production support

### Product & Consulting

SaaS POS systems, workflow automation, business analysis, technical analysis, stakeholder collaboration, system architecture

### AI Productivity & Applied AI

AI-assisted prototyping, debugging, documentation, test generation, workflow acceleration, AI-assisted POS insights, local/LLM assistant workflows

---

## Skill Evidence Map

Use these examples when visitors ask whether Marlon has practical experience with a specific skill.

- **Laravel / PHP:** Used in POS, inventory, call center analytics, TurboDial CRM/dialer workflows, enterprise insurance systems, and client web applications.
- **React / Next.js:** Used for modern web application work, SaaS/product interfaces, and web/mobile ordering ecosystems.
- **React Native:** Used for Smart Laundry POS PH, grocery delivery/mobile ordering, and Android-focused mobile delivery.
- **Vue.js:** Used in call center analytics, health insurance verification, Grocery POS and Inventory, and other web application work.
- **Node.js:** Used in enterprise insurance systems and backend/full-stack project work.
- **Python:** Used in enterprise insurance workflow work and backend/data-processing contexts.
- **Perl:** Listed in backend skills and relevant to legacy/backend engineering capability.
- **MySQL:** Used across POS, inventory, reporting, call center analytics, CRM/dialer, and enterprise workflow systems.
- **Firebase:** Used for serverless backends and React Native/Firebase mobile applications, including grocery delivery workflows.
- **Redis:** Used in TurboDial and call center/CRM-style backend systems.
- **GraphQL:** Used in enterprise health insurance verification work at Zigzag Offshoring.
- **WebSocket:** Used in TurboDial/call center CRM and real-time system contexts.
- **Twilio / HubSpot:** Used in TurboDial, a dialer/call center CRM platform.
- **WordPress:** Used in early career work for theme customization, plugin enhancements, and client marketing sites.
- **AI-assisted products:** Smart POS PH includes AI-assisted sales insights, low-stock alerts, best-seller analysis, profit snapshots, restock recommendations, and peak-hour detection.
- **Production support:** Experience includes monitoring, logging, deployment support, performance improvements, scaling, and production reliability.

---

## Public Project Links

Only reference these links when relevant to a visitor's question.

- **TurboDial:** https://app.turbodial.com
- **Smart POS PH:** https://smart-pos.aiautomated.uk/
- **Smart Laundry POS PH:** https://play.google.com/store/apps/details?id=com.laundrypos
- **Viisor:** https://viisor.com
- **Modwatch app reference:** https://app.modwatchsystems.com

---

## Projects & Products

### Smart Laundry POS PH / Laundry POS and Operations

- **Timeframe:** 2026-Present
- **Type:** Published Android app / laundry POS / shop operations system
- **Public link:** https://play.google.com/store/apps/details?id=com.laundrypos
- **Role:** Owner / Senior Software Engineer / Full Stack Developer
- **Features:** Order and job tracking, receipts, machine tags, daily sales and transaction reports, staff accounts and activity monitoring, consumables audit, real-time cash and payment records, payments, pricing, and operational reporting
- **Strong interview evidence:** Android delivery, React Native/mobile work, POS workflows, small-business SaaS, operational automation, reporting, staff activity tracking, and product ownership

### Smart POS PH

- **Type:** AI-assisted point-of-sale / retail operations / inventory and sales insights platform
- **Public link:** https://smart-pos.aiautomated.uk/
- **Role:** Founder / Senior Software Engineer / Full Stack Developer
- **Features:** Daily sales insights, low-stock alerts, best-seller analysis, profit snapshots, smart restock recommendations, and peak-hour detection
- **Strong interview evidence:** POS, retail operations, AI-assisted products, business intelligence, inventory, sales reporting, SaaS, operational automation, and product-builder experience

### Grocery POS and Inventory

- **Timeframe:** 2025-2026
- **Type:** POS, stock management, sales, and reporting system
- **Stack:** Laravel, Vue, MySQL, React Native
- **Strong interview evidence:** Inventory workflows, sales reporting, Laravel/Vue/MySQL, mobile integration, and operations software

### Grocery Delivery App

- **Timeframe:** 2025
- **Type:** React Native and Firebase mobile application
- **Features:** Browsing, cart flows, and delivery orders
- **Strong interview evidence:** React Native, Firebase, mobile ordering, customer-facing flows, and delivery operations

### TurboDial Dialer / Call Center CRM

- **Type:** Dialer app / call center CRM / sales tool
- **Public link:** https://app.turbodial.com
- **Role:** Senior Software Engineer / Full Stack Developer
- **Stack:** Laravel, Angular, Doctrine, Redis, MySQL, WebSocket, HubSpot, Twilio
- **Strong interview evidence:** CRM, sales tools, call center workflows, dialer operations, Laravel, Angular, real-time systems, WebSocket, Redis, HubSpot, Twilio, and telephony/API integrations

### Health Insurance Claims Verification System

- **Type:** Enterprise insurance workflow system
- **Company context:** Zigzag Offshoring
- **Stack:** Laravel, Vue, React, Node.js, GraphQL, MySQL, Python
- **Work:** Automated verification workflows using aggregated government database data; supported complex workflows and high-volume transaction processing
- **Strong interview evidence:** Enterprise backend work, insurance workflows, transaction processing, external/aggregated data, approvals, reliability, performance, and cross-functional collaboration

### Viisor / Modwatch Workers Compensation Claims Management Platform

- **Public links:** https://viisor.com and https://app.modwatchsystems.com
- **Type:** Workers compensation claims management / risk management / operational workflow platform
- **Role:** Senior Software Engineer / Full Stack Developer during Zigzag engagement
- **Work:** Contributed to production claims, reporting, workflow, and analytics features
- **Strong interview evidence:** Enterprise workflow, claims management, reporting, analytics, task/calendar workflows, document management, permissions, notifications, and operational platforms

### Call Center Analytics Platform

- **Company context:** Magellan Solutions
- **Type:** Real-time dashboard for call center performance and operational reporting
- **Stack:** PHP, MySQL, Laravel, Vue.js
- **Work:** Led development of call center analytics dashboards and internal automation tools; built reporting features for agent performance and operational metrics; supported deployments, scaling, and production reliability improvements
- **Strong interview evidence:** Reporting dashboards, operational metrics, call center analytics, production reliability, scaling, and internal automation

### Client Web Applications

- **Company context:** Highlysucceed Ltd
- **Type:** Portfolio sites, mini checkout systems, and internal business automation tools
- **Work:** Delivered multiple client web applications through rapid iteration and direct stakeholder collaboration; handled end-to-end frontend and backend development
- **Strong interview evidence:** Client delivery, rapid iteration, stakeholder collaboration, full-stack development, maintainability, and fast delivery

### WordPress / Marketing Sites / PSD-to-HTML

- **Company context:** Mindblow Creatives
- **Type:** Client marketing sites and WordPress builds
- **Work:** Converted PSD designs into responsive web pages; customized WordPress themes and plugins
- **Strong interview evidence:** Frontend fundamentals, responsive UI, client branding, WordPress customization, plugin enhancements, and early production delivery
...
- Builds and experiments with local/LLM assistant workflows for portfolio and business automation use cases.
- Keeps AI grounded in practical business value rather than treating it as a standalone novelty.

---

## Engineering Approach

- Understand the business workflow before building.
- Build maintainable systems that solve operational problems clearly.
- Prefer practical, reliable architecture over unnecessary complexity.
- Deliver end-to-end: requirements, implementation, deployment, support, and iteration.
- Use debugging, monitoring, logging, and production support habits to keep systems stable.
- Collaborate directly with stakeholders and cross-functional teams.
- Use AI as an accelerator for delivery and analysis while preserving engineering quality.

---

## Work Style & Strengths

- Strong fit for small teams, startup environments, product teams, and businesses that need one engineer to understand the full workflow.
- Comfortable across backend, frontend, mobile, database, reporting, API integration, and support work.
- Strong at translating business operations into software features.
- Experienced in both enterprise systems and small-business SaaS/product development.
- Practical with production issues: debugging, performance tuning, deployments, scaling, logging, monitoring, and reliability improvements.
- Direct stakeholder collaboration experience from contract work and project-based delivery.
...
Yes. TurboDial used Twilio, HubSpot, WebSocket, Redis, MySQL, Doctrine, Angular, and Laravel for sales teams, call center CRM workflows, and dialer operations.
...
Smart Laundry POS PH is a published Android app and POS platform for laundry shops. It supports order and job tracking, receipts, machine tags, daily sales and transaction reports, staff accounts and activity monitoring, consumables audits, real-time cash and payment records, pricing, and operational reporting.

### 19. What is Smart POS PH?

Smart POS PH is an AI-assisted point-of-sale platform for retail operations. Its public features include daily sales insights, low-stock alerts, best-seller analysis, profit snapshots, smart restock recommendations, and peak-hour detection.
...
Relevant public links include Smart POS PH at https://smart-pos.aiautomated.uk/, Smart Laundry POS PH at https://play.google.com/store/apps/details?id=com.laundrypos, TurboDial at https://app.turbodial.com, Viisor at https://viisor.com, and the Modwatch app reference at https://app.modwatchsystems.com.
